...
@Provider
public class AlunoNotFoundExceptionMapper implements ExceptionMapper<AlunoNotFoundException> {

    @Override
    public Response toResponse(AlunoNotFoundException exception) {
